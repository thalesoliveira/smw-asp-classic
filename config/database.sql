...
INSERT INTO t_user (user_first_name, user_last_name, type_user_id, country_id, state_id, user_login, user_password) VALUES ('Admin', 'Root', 1 ,32, 26, 'teste@gmail.com', 'abcd1234');
...
CREATE TABLE t_phone_team (
	phone_id int NOT NULL,
    team_id int NOT NULL    
    CONSTRAINT PK_t_team_phone PRIMARY KEY (phone_id, team_id),
);
